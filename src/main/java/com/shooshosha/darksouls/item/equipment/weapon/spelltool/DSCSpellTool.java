...
package com.shooshosha.darksouls.item.equipment.weapon.spelltool;
 ...
 * @author shooshosha
 */
public abstract class DSCSpellTool extends DSCItemWeapon{
    private static Set<DSCSpellTool> spellTools = new HashSet<DSCSpellTool>();

    public DSCSpellTool(String unlocalName) {
        super("spellTool." + unlocalName);
        spellTools.add(this);
    }

    public static Set<DSCSpellTool> getSpellTools() {
        return spellTools;
    }
}

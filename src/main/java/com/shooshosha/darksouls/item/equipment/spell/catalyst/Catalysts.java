...
package com.shooshosha.darksouls.item.equipment.spell.catalyst;

import com.shooshosha.darksouls.item.equipment.spell.DSCSpellTool;

/**
 * @author shooshosha
 */
public class Catalysts extends DSCSpellTool {
}
